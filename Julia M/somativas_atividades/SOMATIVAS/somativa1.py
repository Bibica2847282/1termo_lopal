...
nível = input("Digite seu nível: ")

print("O jogador" , nickname, "está no nível", nível, "e está pronto para a partida!")
...
print("O valor em Megabytes é: " , valor)
...
pergunta1 = int(input("Você comeu um salgado e um suco, qual o preço do salgado? "))
pergunta2 = int(input("E do suco? "))
